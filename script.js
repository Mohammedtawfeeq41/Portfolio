window.onload = function () {
    emailjs.init("HYuOiNmDVPeRocERi"); // Your actual EmailJS Public Key
};
...
function sendemail(event) {
    ...
    let templateParams = {
        to_name: "MohammedTawfeeq", // Receiver's name
    ...
    emailjs.send("service_1409z4o", "template_6tcbe7m", templateParams)
